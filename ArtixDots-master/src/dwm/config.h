...
static const char *fonts[]          = { "JetBrainsMonoNL-Regular:size=10" };
static const char dmenufont[]       = "JetBrainsMonoNL-Regular:size=12";
static const char col_gray1[]       = "#1e1e2e";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#005577";
static const char col_purp[]        = "#730077";
static const char col_wht[]         = "#ffffff";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_purp,  col_wht  },
};
